...
/* USER CODE BEGIN PV */
uint16_t LEDs[8] = {GPIO_PIN_1, GPIO_PIN_2, GPIO_PIN_3, GPIO_PIN_4, GPIO_PIN_5, GPIO_PIN_6, GPIO_PIN_7, GPIO_PIN_8};
/* USER CODE END PV */
...
int main(void)
{
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	for (int i = 0; i < 4; i++) {
		HAL_GPIO_TogglePin (GPIOG, LEDs[i]);
		HAL_GPIO_TogglePin (GPIOG, LEDs[7-i]);
		HAL_Delay (150);
	}
    /* USER CODE BEGIN 3 */
  }
