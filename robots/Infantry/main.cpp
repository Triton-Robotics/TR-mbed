...
int main(){
    DJIMotor pitchMot(7, CANHandler::CANBUS_2, GM6020, "pitch_motor");
    DJIMotor yawMot(5, CANHandler::CANBUS_1, GM6020, "yaw_motor");

    pitchMot.setPositionPID(16.2644,0.024926,1200.2213);
    pitchMot.setPositionIntegralCap(3000);
    pitchMot.pidPosition.feedForward = -3550;
