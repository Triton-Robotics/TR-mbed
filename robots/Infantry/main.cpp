...
int yawVelo = 0;
// TODO this only works because of #include ChassisSubsystem.h probably spend some time to make the includes nice
...
//     init();
//     init_jetson(bcJetson);
//     imuThread.start(imu_thread);
//     refThread.start(ref_thread);

//     while (true)
//     {
//         timeStartCV = us_ticker_read();
//         mutex_test.lock();
//         imuAnglesLocal.yaw = imuAngles.yaw;
//         imuAnglesLocal.pitch = imuAngles.pitch;
...
// #ifdef USE_IMU
//         error = DJIMotor::s_calculateDeltaPhaseF(yaw_desired_angle, imuAnglesLocal.yaw + 180, 360);
...
//         yaw.setPower(0);
// #ifdef USE_IMU
//         yaw_desired_angle = imuAnglesLocal.yaw + 180;
// #endif
//     }
...
//     jetson_send_data.yaw_angle_rads = (imuAnglesLocal.yaw + 180.0) * (M_PI / 180.0);
