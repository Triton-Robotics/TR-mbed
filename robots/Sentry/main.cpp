...
// DJIMotor indexerL(5, CANHandler::CANBUS_1, C610,"IndexerL");
// DJIMotor indexerR(6, CANHandler::CANBUS_1, C610,"IndexerR");
...
// DJIMotor RFLYWHEEL_U(7, CANHandler::CANBUS_1, M3508,"RightFlyU");
// DJIMotor LFLYWHEEL_D(8, CANHandler::CANBUS_1, M3508,"LeftFlyD");
...
//     // Auto code
//     std::vector<std::vector<float>> final_pos = {{0.0, 0.0}, {0.0,10.0}, {-10.0, 10.0}};
...
//                 Chassis.setChassisSpeeds({values.lx, values.ly, values.rx}, 80, ChassisSubsystem::ROBOT_ORIENTED);
...
//             //     LFLYWHEEL_U.setPower(300);
//             //     RFLYWHEEL_U.setPower(300);
//             //     LFLYWHEEL_D.setPower(300);
//             //     RFLYWHEEL_D.setPower(300);

//             //     indexerR.setPower(130*19);
//             //     indexerL.setPower(130*19);
//             // } 
//             // else {
//             //     LFLYWHEEL_U.setPower(0);
//             //     RFLYWHEEL_U.setPower(0);
//             //     LFLYWHEEL_D.setPower(0);
//             //     RFLYWHEEL_D.setPower(0);
...
//             if (remote.rightSwitch() == Remote::SwitchState::UP) {
//                 // LFLYWHEEL_U.setSpeed(2000);
//                 RFLYWHEEL_U.setSpeed(2000);
//                 LFLYWHEEL_D.setSpeed(2000);
//                 // RFLYWHEEL_D.setSpeed(2000);

//                 indexerR.setSpeed(5*16*M2006_GEAR_RATIO);
//                 indexerL.setSpeed(5*16*M2006_GEAR_RATIO);

//                 Chassis.getMotor(ChassisSubsystem::RIGHT_BACK).setSpeed(130*19);
//                 Chassis.getMotor(ChassisSubsystem::LEFT_BACK).setSpeed(130*19);
//                 Chassis.getMotor(ChassisSubsystem::RIGHT_FRONT).setSpeed(130*19);
//                 Chassis.getMotor(ChassisSubsystem::LEFT_FRONT).setSpeed(130*19);
//             } else {
...
//                 // printff("remote values: %d %d %d %d\n", remote.leftX(), remote.leftY(), remote.rightX(), remote.rightY());
//             }
