...
>>>>>>> main
            ...
            pitch.pidPosition.debugPIDterms = true;
            ...
            if(internalTimer > 5){
                if(rS == Remote::SwitchState::DOWN)
                    printff("p[%d] i[%d] d[%d] ",(int)(kP*1000),(int)(kI*1000),(int)(kD*1000));
                //printff("DES:%d ACT:%d PWR:%d\n",pitch>>ANGLE,((int)lS - 2)*500 + 6800, pitch>>POWEROUT);
