...
int main(){
    ...
    */
    ...
    yaw.setSpeedPID(400, 0.05, 1.5); // checkpoint 1: 450, 0.08, 2.5
    ...
    while(true){
        ...
        if ((timeStart - loopTimer) / 1000 > OUTER_LOOP_DT_MS){
            ...
            if (drive == 'u' || drive == 'd' || (drive =='o' && (remote.rightSwitch() == Remote::SwitchState::UP || remote.rightSwitch() == Remote::SwitchState::DOWN))){
                ...
                yaw.pidSpeed.feedForward = (-5.30094881524873*yawVelo*yawVelo*dir + 461.129143101395*yawVelo + 340.235249010233 * dir);
