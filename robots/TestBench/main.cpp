...
//             // unsigned long timeNow = us_ticker_read();
//             // for (int x = 0; x < 150; x++){ //Get 150 samples
//             // unsigned long elapsedTime = timeNow - timeBefore;
//             // if (elapsedTime < 3000) { // delay 3 miliseconds between each sample
//             //     continue;
//             // } 
//             // AcsValue = curr.read(); //Read current sensor values
//             // Samples = Samples + AcsValue; //Add samples together

//             // timeBefore = timeNow;
//             // }

//             // unsigned long timeAfter = us_ticker_read();
//             // if ((timeAfter - timeBefore) > 0.3ms) {

//             // }
            
//             // AvgAcs=Samples/150.0;//Taking Average of Samples
//             // AcsValueF = (2.5 - (AvgAcs * (5.0 / 1024.0)) )/0.066;
//             // printff("%.3f\n", AcsValueF);//Print the read current on Serial monitor
//             // delay(50);


//             // printff("%.3f\n", curr.read());

//             /**timebefore = time.read()
//              * 
//              * adjsadkla
//              * 
//              * timenow = time.read()
//              * 
//              * if timenow-timebefore > 0.3ms {
//              * sample
//              * }
//              */
...
//             printff("AVG: %.5f mV\t%.5f\t%.5f\n", avg*5000, read, chassis_power);
            
//             // printff("AMP: %.4f A\t", (2.495 - (avg / 1023.0 * 5.0)) / MV_PER_A);
//             // printff("PWR: %.4f W\n", 24 * (2.495 - (avg / 1023.0 * 5.0)) / MV_PER_A);
