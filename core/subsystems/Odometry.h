#ifndef TR_EMBEDDED_ODOMETRY_SUBSYSTEM_H
#define TR_EMBEDDED_ODOMETRY_H
...
/**
 * The Odometry class is a wrapper for the DJIMotor class that allows for observation of the chassis.
 *
 * The Odometry class requires an IMU. 
 */
class Odometry
{
public:
    /**
     * The Odometry constructor. This constructor takes in the ChassisSubsystem object.
     * @param chassis requires an existing chassis class to pass it in. 
     */
    Odometry(ChassisSubsystem &chassis);
