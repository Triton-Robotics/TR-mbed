...
void ChassisSubsystem::setChassisSpeedsPWR(double fwd, double strafe, double chassis_power, double chassis_power_limit) //the edge algorithem
{
    double huiandward = 0;
    ...
    //         huiandward = rpmToRadPerSecond(25);   //set huiandward to a lower value
