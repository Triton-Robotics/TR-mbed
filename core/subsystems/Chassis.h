...
public:
    ...
    void driveXYRPower(float ref_chassis_power, uint16_t max_power, double lX, double lY, double dt, bool beyblading = false);
    
    void driveOffsetAnglePower(float ref_chassis_power, uint16_t max_power, ChassisSpeeds speeds, double angleOffset, int dt);
    
    void driveTurretRelativePower(float ref_chassis_power, uint16_t max_power, ChassisSpeeds speeds, double turretAngleDegrees, int dt);
